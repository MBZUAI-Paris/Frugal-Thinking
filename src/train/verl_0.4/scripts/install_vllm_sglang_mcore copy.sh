...
# pip install --no-cache-dir "vllm==0.9.2" "torch==2.7.0" "torchvision==0.21.0" "torchaudio==2.6.0" "tensordict==0.6.2" torchdata
# pip install --no-cache-dir "vllm==0.9.2" "torch==2.7.1" "torchvision==0.21.0" "torchaudio==2.6.0" "tensordict==0.6.2" torchdata
pip install --no-cache-dir "vllm==0.9.1" "torch==2.7.1" "torchvision" "torchaudio" "tensordict==0.9.1" torchdata

echo "2. install basic packages"
# pip install "transformers[hf_xet]>=4.51.0" accelerate datasets peft hf-transfer \
pip install "transformers[hf_xet]>=4.53.3" accelerate datasets peft hf-transfer \
...
pip install --no-cache-dir flashinfer-python==0.2.7.post1+cu124
